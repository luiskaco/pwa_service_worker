...
//Inicializar Camara
const referenciaCamaraID =  document.getElementById('player')

// const camara = new Camara($('#player')[0])
const camara = new Camara(referenciaCamaraID)


// ===== Codigo de la aplicación

function crearMensajeHTML(mensaje, personaje, lat, lng, foto = null) {
...
// Buen practica  
// URL https://web.dev/native-hardware-user-location/
...
btnPhoto.on('click', () => {
    ...
    // Mostramos el espacio de camara
